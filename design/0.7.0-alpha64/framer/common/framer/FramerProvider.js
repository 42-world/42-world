import*as t from"react";import{useEffect as i}from"react";var e="443c42d29a3df921dc181dfda55627c84aa5d8434e67b92fa91f029f72958f8e",a=`@import url('https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.6/dist/web/variable/pretendardvariable.css');
...
`;(function(){if(!document.getElementById(e)){var n=document.createElement("style");n.id=e,n.textContent=a,document.head.appendChild(n)}})();import{useFramerThemeData as c}from"./useFramerThemeData.js";function w({children:n}){let r=c();return i(()=>{let o=window.document;r?o.documentElement.classList.add("dark"):o.documentElement.classList.remove("dark")},[r]),t.createElement(t.Fragment,null,n)}export{w as FramerProvider};
