import*as t from"react";import{useEffect as a}from"react";var o="443c42d29a3df921dc181dfda55627c84aa5d8434e67b92fa91f029f72958f8e",e=`@import url('https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.6/dist/web/variable/pretendardvariable.css');
...
`;(function(){if(!document.getElementById(o)){var n=document.createElement("style");n.id=o,n.textContent=e,document.head.appendChild(n)}})();import{setTheme as i}from"../../utils/index.js";import{useFramerThemeData as c}from"./useFramerThemeData.js";function w({children:n}){let r=c();return a(()=>{i(r?"dark":"light")},[r]),t.createElement(t.Fragment,null,n)}export{w as FramerProvider};
