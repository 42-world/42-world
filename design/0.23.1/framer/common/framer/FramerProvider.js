import*as t from"react";import{useEffect as a}from"react";var o="4c4b874d5fae68ad66a239c25bf1e41660d6bd9c3329fc4d126b02cc98f17fd4",e=`@import url('https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.6/dist/web/variable/pretendardvariable.css');
...
`;(function(){if(!document.getElementById(o)){var n=document.createElement("style");n.id=o,n.textContent=e,document.head.appendChild(n)}})();import{setTheme as i}from"../../utils/index.js";import{useFramerThemeData as c}from"./useFramerThemeData.js";function g({children:n}){let r=c();return a(()=>{i(r?"dark":"light")},[r]),t.createElement(t.Fragment,null,n)}export{g as FramerProvider};
