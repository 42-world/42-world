...
`;(function(){if(!document.getElementById(o)){var n=document.createElement("style");n.id=o,n.textContent=a,document.head.appendChild(n)}})();import{useFramerThemeData as c}from"./useFramerThemeData.js";function b({children:n}){let e=c();return i(()=>{let r=window.document;e?r.documentElement.classList.add("dark"):r.documentElement.classList.remove("dark")},[e]),t.createElement(t.Fragment,null,n)}export{b as FramerProvider};
